...
COPY public.ordered_items (chrt_id, track_number, price, rid, name, sale, size, total_price, nm_id, brand, status, order_uid) FROM stdin;
\.
...
ALTER TABLE ONLY public.ordered_items
    ADD CONSTRAINT ordered_items_pkey PRIMARY KEY (order_uid);
...
--
-- Name: ordered_items order_uid; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.ordered_items
    ADD CONSTRAINT order_uid FOREIGN KEY (order_uid) REFERENCES public.orders(order_uid) NOT VALID;
